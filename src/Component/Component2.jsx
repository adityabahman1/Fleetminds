            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="bg-[#0f172a] border border-slate-800 rounded-3xl p-6 sm:p-8 hover:border-slate-700 transition-colors group"
                        >
                            <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center mb-4 sm:mb-6 ${feature.bgColor}`}>
                                <feature.icon className={`w-6 h-6 sm:w-7 sm:h-7 ${feature.color}`} strokeWidth={2} />
                            </div>
